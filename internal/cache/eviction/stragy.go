// Package eviction provides cache eviction strategies including LRU for now 
...
const (
	...
	// TODO EvictionLFU represents Least Frequently Used strategy
	EvictionLFU
	// TODO EvictionFIFO represents First In First Out strategy
	EvictionFIFO
)
